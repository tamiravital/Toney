      ...
      >
        ...
        {loading && (
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
            ...
            <p className="text-sm text-muted">Preparing your session notes...</p>
          </div>
        )}

        {/* Content (when notes are loaded) */}
        {!loading && notes && (
          <>
            {/* Scrollable content */}
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5 hide-scrollbar">
              ...
              {/* Feedback — emoji mandatory, text optional */}
              {onSubmitFeedback && (
                <div className="bg-surface rounded-2xl p-4">
