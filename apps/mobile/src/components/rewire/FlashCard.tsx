...
function CardFront({ insight }: { insight: CategorizedInsight }) {
  ...
  return (
    <div className={`w-full h-full rounded-3xl p-8 flex flex-col items-center justify-center ${style.shell} relative`}>
      ...
      {/* Focus badge */}
      {insight.is_focus && (
        <span className="mt-4 flex items-center gap-1 text-[10px] font-bold text-accent bg-accent-light px-2.5 py-1 rounded-full uppercase tracking-wide">
      ...
      {/* Tap hint */}
      <p className="absolute bottom-6 text-[11px] text-muted font-medium">
        Tap to flip
      </p>
    </div>
  );
  ...
  return (
    <div className={`w-full h-full rounded-3xl flex flex-col ${style.shell} overflow-hidden`}>
      ...
      <div className="flex items-center gap-2 px-5 pt-5 pb-3 flex-shrink-0">
        ...
        {insight.is_focus && (
          <span className="flex items-center gap-1 text-[10px] font-bold text-accent bg-accent-light px-2 py-0.5 rounded-full uppercase tracking-wide">
            <Target className="w-3 h-3" />
            Focus
          </span>
        )}
      ...
      <div className="flex items-center justify-center gap-2 px-5 py-4 border-t border-default flex-shrink-0">
        <button
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-semibold text-btn-secondary-text bg-btn-secondary hover:bg-btn-secondary-hover transition-all"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-semibold text-danger bg-danger-light hover:opacity-80 transition-all"
        >
