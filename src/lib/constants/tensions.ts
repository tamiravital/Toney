import { TensionType, TensionDetails, TensionColors, IdentifiedTension } from '@/types';
...
export function tensionColor(type: TensionType): TensionColors {
  ...
  return colors[type] || colors.avoid;
}
